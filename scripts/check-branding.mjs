...
//    Header memuat wordmark tipografis; emblem maksimal satu per halaman (beranda sejak R9.3: tanpa emblem; halaman lain: footer).
...
for (const file of pages) {
  ...
  // Emblem resmi: maksimal satu per halaman (beranda sejak R9.3 tidak menampilkannya).
